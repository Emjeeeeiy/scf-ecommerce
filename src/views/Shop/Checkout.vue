    ...
    <section class="grid gap-8 lg:grid-cols-[1.3fr_0.8fr]">
      ...
      <aside class="space-y-6 lg:sticky lg:top-24 h-fit">
        <div class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div v-if="message" class="mt-4 flex items-start gap-2 rounded-lg p-3 text-[10px] font-bold uppercase tracking-wider" :class="message.includes('success') ? 'bg-emerald-50 text-emerald-700' : 'bg-rose-50 text-rose-700'">
        ...
        <div class="relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl flex flex-col max-h-[90vh] border border-neutral-200">
          ...
          <div class="overflow-y-auto p-5 sm:p-6 custom-scrollbar">
            ...
            <div class="mb-8 flex flex-col items-center">
              <div class="mb-5 inline-block rounded-full bg-blue-50 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-blue-600 border border-blue-100">
            ...
            <div class="space-y-6">
              <div class="text-center">
                <div class="mb-5 inline-block rounded-full bg-emerald-50 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-emerald-600 border border-emerald-100">
                  Step 2: Upload Proof
                </div>
              </div>
              ...
              <div class="space-y-1.5">
                ...
                <div class="relative overflow-hidden rounded-xl border-2 border-dashed border-neutral-200 bg-neutral-50 transition-colors hover:bg-neutral-100 group">
                  ...
                  <div v-else class="p-2">
                    ...
                    <div class="mt-3 text-center text-[10px] font-bold text-blue-600 uppercase tracking-wider bg-white/80 py-2 rounded-lg backdrop-blur-sm">Change Receipt Image</div>
                  </div>
                </div>
              </div>
              ...
              <div v-if="isVerifying || receiptStatus" class="flex items-center gap-3 rounded-xl p-4 text-[11px] font-bold uppercase tracking-wider border transition-all animate-in fade-in slide-in-from-top-2"
                :class="{
                  'bg-blue-50 border-blue-100 text-blue-700': isVerifying,
                  'bg-emerald-50 border-emerald-100 text-emerald-700': receiptStatus === 'legit',
                  'bg-rose-50 border-rose-100 text-rose-700': receiptStatus === 'fake'
                }"
              >
