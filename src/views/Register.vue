      ...
      <div class="overflow-hidden rounded-4xl bg-white border border-neutral-300 ring-1 ring-neutral-100">
        ...
        <div class="p-8 sm:p-10">
          ...
          <form class="space-y-5" @submit.prevent="handleRegister">
            ...
            <div class="flex items-center gap-3 rounded-2xl border border-neutral-200 bg-neutral-50/50 p-4">
              <input
                id="isStudent"
                v-model="form.isStudent"
                type="checkbox"
                class="h-5 w-5 rounded border-neutral-300 text-amber-500 focus:ring-amber-400"
              />
          ...
          <div class="mt-5 flex flex-col items-center gap-6 border-t border-neutral-300 pt-3 text-center">
            <p class="text-[11px] font-medium leading-relaxed text-neutral-400">
              ...
              <router-link to="/login" class="block mt-1 font-black text-neutral-900 hover:underline">Sign In</router-link>
            </p>
          </div>
        </div>
      </div>
